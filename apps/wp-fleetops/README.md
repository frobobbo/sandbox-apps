...
- Reject blank site names, negative or SQLite-out-of-range operational metrics, non-HTTP(S) site URLs, malformed URLs without a hostname or valid port, and URLs containing embedded credentials before snapshots can be persisted or exported.

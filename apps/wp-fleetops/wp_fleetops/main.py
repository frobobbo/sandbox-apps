...
@app.post('/snapshot')
def snapshot(name: str=Form(..., min_length=1), url: str=Form(..., min_length=1, pattern=r'^https?://'), uptime_ok: bool=Form(False), ssl_days: int=Form(60, ge=0, le=SQLITE_INTEGER_MAX), wp_updates: int=Form(0, ge=0, le=SQLITE_INTEGER_MAX), backup_age_hours: int=Form(24, ge=0, le=SQLITE_INTEGER_MAX), response_ms: int=Form(250, ge=0, le=SQLITE_INTEGER_MAX), security_header_count: int=Form(3, ge=0, le=SQLITE_INTEGER_MAX)):

...
- Normalize bare site domains and mixed-case hosts to `https://` so duplicate entries do not split history and both automatic and manual reports use the canonical URL.
